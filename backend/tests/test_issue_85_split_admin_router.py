...
class TestPreserveExistingTestCoverageThroughSplit:
    ...
    def test_full_suite_pass_skip_counts_match_pre_split_baseline(self):
        """`cd backend && python -m pytest tests/ -v` reports the same 670 passed / 10 skipped as before the split.
        ...
        plan-issue-111-week-boundary-formula's 7 new tests did after that)."""
        ...
        assert "670 passed" in output, output[-3000:]
