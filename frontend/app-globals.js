...
function switchTab(name) {
  ...
  if (name === "admin")  { if (!activeUserId || !activeIsAdmin) return; loadAdminWeeks(); loadWeights(); loadUsers(); loadTags(); loadCodes(); loadNotifications(); loadTokenGrantEvents(); loadPlayerPool(); loadAuditLog(); }
}
